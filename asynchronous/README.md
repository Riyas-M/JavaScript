...
- ### Key concepts in asynchronous JavaScript includes: 
    ...
    - #### **Callbacks (Since inception):**
        ...
        - This was an early approach to handling asynchronous code, but can lead to [Callback-Hell](https://medium.com/@raihan_tazdid/callback-hell-in-javascript-all-you-need-to-know-296f7f5d3c1) (***nested***, ***hard-to-read code*** & ***multiple callbacks together***) in complex scenarios.
...
### Key Differences:
  ...
  - **_Async/Await:_**
    ...
    - Once the Promise is resolved, the execution of the async function `async () => {}` resumes, and the result of the Promise is returned. If rejected, it throws an error value.
...
### Conclusion:
  ...
  -  Developers can create more efficient and responsive applications by using features like **_callbacks_**, **_async/await_**, & **_promises_**.
...
- [Callback Hell in JavaScript](https://medium.com/@raihan_tazdid/callback-hell-in-javascript-all-you-need-to-know-296f7f5d3c1)